...
async function main() {
    ...
    try {
        ...
        for (const artifact of verifierArtifacts) {
            const Verifier = await ethers.getContractFactory(artifact);
        ...
        try {
            const implementationAddress = await upgrades.erc1967.getImplementationAddress(battleship.target);
            console.log("Implementation deployed to:", implementationAddress);
            
            const adminAddress = await upgrades.erc1967.getAdminAddress(battleship.target);
